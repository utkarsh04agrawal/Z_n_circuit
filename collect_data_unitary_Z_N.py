from circuit_utils import get_data_unitary_Z_N, get_entropy, get_Z_N_entropy
...
p_meas = [0,0.01,0.03,0.05,0.075,0.085,0.1,0.2]
g_N = [0,0.01,0.03,0.05,0.1,0.2]
depth_ratio = 5
fuzzy_initial_state = True
if fuzzy_initial_state:
    root_directory = 'data/unitary_Z_n/U_1_fuzzy_initial'
else:
    root_directory = 'data/unitary_Z_n/U_1_sharp_initial'
    ...
    for g in g_N:
        for L in L_list:
            ...
            for _ in range(samps):
                ...
                prob_list,_ = get_data_unitary_Z_N(L,N,T,p,g,seed_U=seed_U,seed_M=seed_M,seed_N=seed_N)
